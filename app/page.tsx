  ...
  return (
    <main>
      <nav className="nav-shell" aria-label="Main navigation">
        ...
        <div className="nav-links"><a href="#work">Work</a><a href="#experience">Experience</a><a href="#skills">Skills</a><a className="nav-contact" href="#contact">Let&apos;s talk <span>↗</span></a></div>
      </nav>
      ...
      <section className="hero section-shell" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><a className="button button-primary" href="#work">Explore my work <span>↓</span></a><a className="text-link" href="/resume.pdf" download>Download resume <span>↓</span></a><a className="text-link hero-email" href="mailto:m.rendy111103@gmail.com">Email me <span>↗</span></a></div>
      ...
      <section className="contact-section section-shell" id="contact"><p className="section-kicker">07 / CONTACT</p><h2>Have a data problem<br /><em>worth solving?</em></h2><a className="contact-email" href="mailto:m.rendy111103@gmail.com">m.rendy111103@gmail.com <span>↗</span></a><div className="contact-bottom"><span>Jakarta, Indonesia</span><div><a href="https://www.linkedin.com/in/rendyuiop/" target="_blank" rel="noreferrer">LinkedIn ↗</a><a href="https://github.com/Rendyuiop" target="_blank" rel="noreferrer">GitHub ↗</a></div></div></section>
      <footer className="footer section-shell"><span>© 2026 Muhammad Rendy</span><span>Designed &amp; engineered with intent.</span><a href="#top">Back to top ↑</a></footer>
    </main>
  );
}
